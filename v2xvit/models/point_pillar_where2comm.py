...
class PointPillarWhere2comm(nn.Module):
    def __init__(self, args, noise_setting):
        super(PointPillarWhere2comm, self).__init__()
        self.noise = noise_setting
    ...
    def forward(self, data_dict):
        ...
        for i in range(len(communication_masks)):
            ...
            for j in range(1,cav_num):
                ...
                t_matrix = get_t_matrix(ego_mask,other_mask, noise=self.noise) # get fine-grid transformation matrix
